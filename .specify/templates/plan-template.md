...
- **Quality**: Account for loading, empty, error, and success states plus keyboard and
  accessible-name requirements for interactive controls.
- **Compliance**: Any violation MUST be recorded in Complexity Tracking with a reason,
  rejected alternative, and scope of the exception.
